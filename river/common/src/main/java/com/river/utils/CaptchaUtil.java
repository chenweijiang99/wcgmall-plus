...
public class CaptchaUtil {
     ...
     * @return boolean
     **/
    public static void checkImageCode(String imageKey, String imageCode, Integer allowDeviation) {
        ...
        // 根据移动距离判断验证是否成功
        if (Math.abs(Integer.parseInt(text.toString()) - Integer.parseInt(imageCode)) > allowDeviation) {
